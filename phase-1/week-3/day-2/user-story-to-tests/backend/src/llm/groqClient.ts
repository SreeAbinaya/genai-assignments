...
export class GroqClient {
  ...
  async generateFeature(systemPrompt: string, userPrompt: string): Promise<GroqResponse> {
    return this.generateCompletion(systemPrompt, userPrompt)
  }

  private async generateCompletion(systemPrompt: string, userPrompt: string): Promise<GroqResponse> {
